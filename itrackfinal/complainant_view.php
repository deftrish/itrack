        ...
        <div class="row">
            <div class="col-md-4">
                <div class="input-group">
                    <input id="search" class="form-control py-2 border-right-0 border" type="text"placeholder="Search for keywords" >
            ...
            <div class="col-md-12">
                ...
                <table class="table table-striped">
                    ...
                    <?php
                        ...
                        as remarks on adminview_id = benNum where adminview.userID = $id";
